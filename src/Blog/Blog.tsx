        ...
        translations: MyLocalizedStrings.create({
            en: {
                ...
                content: () => <>
                    ...
                    <h2 class="mt-4">Extreme Ironing: A Brief History</h2>
                    ...
                    <h2 class="mt-4">Extreme Ironing Adventures</h2>
            ...
            de: {
                ...
                content: () => <>
                    ...
                    <h2 class="mt-4">Extrem-Bügeln: Eine kurze Geschichte</h2>
                    ...
                    <h2 class="mt-4">Extrem-Bügeln-Abenteuer</h2>
