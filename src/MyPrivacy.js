...
//generator https://www.generator-datenschutzerkl%C3%A4rung.de/generator
const email = <a href="mailto:my@email.com">my@email.com</a>
...
const strings = new MyLocalizedStrings({
    de: {
        privacy: () => <>
            ...
            Dies ist die Website von {email}
            ...
            {/*TODO wenn irgendwo github verlinkt, hier abschnitt zu github einfügen*/}
        ...
        moreinfo: () =>
            <>
                ...
                <p>Durch einen Klick auf den Button "Abmelden" neben dem "Kommentieren"-Button wird der Cookie wieder gelöscht.</p>
    ...
    en: {
        ...
        privacy: () => <>
            ...
            <p>This website is run by {email}</p>
            ...
            <h4 class="jet-listing-dynamic-field__content">Cookies</h4><h5>a) Session cookies</h5>
